      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="message-morning" className="text-sm font-normal">
              Good morning
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="message-evening" className="text-sm font-normal">
              Good Evening
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <RadioGroupItem id="message-professional" value="professional" />
            <Label
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="tone-romantic" className="text-sm font-normal">
              Romantic
            </Label>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="tone-thoughtful" className="text-sm font-normal">
              Thoughtful
            </Label>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="tone-professional" className="text-sm font-normal">
              Professional
            </Label>
          </div>
        </div>
        ...
        <div className="space-y-2 pt-1">
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={() => handleEnhancementToggle("include quote")}
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={() => handleEnhancementToggle("make it poetic")}
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              checked={settings.enhancements.includes("make it heartfelt")}
              onCheckedChange={() =>
